...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   gamevar: () => (/* binding */ gamevar)\n/* harmony export */ });\n/* harmony import */ var _index_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.css */ \"./src/index.css\");\n/* harmony import */ var _ship_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ship.js */ \"./src/ship.js\");\n/* harmony import */ var _ship_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_ship_js__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var _gameboard_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./gameboard.js */ \"./src/gameboard.js\");\n/* harmony import */ var _game_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./game.js */ \"./src/game.js\");\n/* harmony import */ var _createBord_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./createBord.js */ \"./src/createBord.js\");\n\n\n\n\n\n\n\n\n\nlet gamevar = new _game_js__WEBPACK_IMPORTED_MODULE_3__.game()\n;(0,_createBord_js__WEBPACK_IMPORTED_MODULE_4__.createBoard)(document.getElementById(\"player1\"),gamevar.player1.name)\n;(0,_createBord_js__WEBPACK_IMPORTED_MODULE_4__.createBoard)(document.getElementById(\"player2\"),gamevar.player2.name)\n\nfor(let count = 1; count < 6; count++){\n    let list = []\n    for(let i = 0; i < count; i++){\n        list.push([count,i])\n    }\n    gamevar.player1.board.place(list, new _ship_js__WEBPACK_IMPORTED_MODULE_1__.Ship(count,list))\n}\n\nfor(let count = 1; count < 6; count++){\n    let list = []\n    for(let i = 0; i < count; i++){\n        list.push([count,i])\n    }\n    gamevar.player2.board.place(list, new _ship_js__WEBPACK_IMPORTED_MODULE_1__.Ship(count,list))\n}\nconsole.log(gamevar)\n\n\n//# sourceURL=webpack:///./src/bundle.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   findcolor: () => (/* binding */ findcolor)\n/* harmony export */ });\nfunction findcolor(ship){\n    switch(ship.shiplength){\n        case(1):\n            return \"#AC16F7\"\n        case(2):\n            return \"#16F761\"\n        case(3):\n            return \"#E8F716\"\n        case(4):\n            return \"#F716E8\"\n        case(5):\n            return \"#16F7D2\"\n    }\n}\n\n//# sourceURL=webpack:///./src/color.js?");

/***/ }),

/***/ "./src/computer-geuss.js":
/*!*******************************!*\
  !*** ./src/computer-geuss.js ***!
  \*******************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   createBoard: () => (/* binding */ createBoard)\n/* harmony export */ });\n/* harmony import */ var _bundle_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./bundle.js */ \"./src/bundle.js\");\n\n\nfunction createBoard(board, player){\n    for(let rowi = 0;rowi < 10; rowi++){\n        let div = document.createElement(\"div\")\n        div.id = `${rowi}`\n        for(let coli = 0; coli < 10; coli++){\n            let block = document.createElement(\"div\")\n            block.id = `[${rowi},${coli}]`\n            let but = document.createElement(\"div\")\n            but.addEventListener((\"click\"), () => {\n                console.log(_bundle_js__WEBPACK_IMPORTED_MODULE_0__.gamevar.turn.name)\n                if(_bundle_js__WEBPACK_IMPORTED_MODULE_0__.gamevar.turn.name === player){\n                let a = block.id.split(\"\")\n                console.log(a)\n                let i = []\n                i.push(a[3])\n                i.push(a[1])\n                console.log(i)\n                let attack = _bundle_js__WEBPACK_IMPORTED_MODULE_0__.gamevar.attack(i)\n\n                block.removeChild(but)\n                }\n            })\n            but.classList.add(\"block-but\")\n            block.appendChild(but)\n            div.appendChild(block)\n        }\n        board.appendChild(div)\n    }\n}\n\n//# sourceURL=webpack:///./src/createBord.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   game: () => (/* binding */ game)\n/* harmony export */ });\n/* harmony import */ var _player__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./player */ \"./src/player.js\");\n/* harmony import */ var _computer_geuss_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./computer-geuss.js */ \"./src/computer-geuss.js\");\n\n\n\n\nclass game{\n    constructor(){\n        this.player1 = new _player__WEBPACK_IMPORTED_MODULE_0__.player(\"player1\"),\n        this.player2 = new _player__WEBPACK_IMPORTED_MODULE_0__.player(\"player2\"),\n        this.turn = this.player1\n    }\n    attack(cord){\n        let x = this.turn.attack(cord)\n        console.log(this.turn)\n        if(x === true){\n            this.turn.sank += 1\n            this.allSank()\n        }\n        if(this.turn === this.player1){\n            this.turn = this.player2\n        }else if(this.turn === this.player2){\n            this.turn = this.player1\n        }\n        if(this.turn === this.player2){\n            let compcords = (0,_computer_geuss_js__WEBPACK_IMPORTED_MODULE_1__.compattack)()\n            this.turn.attack(compcords)\n            this.turn = this.player1\n        }\n        \n    }\n    allSank(){\n        if(this.turn.sank === 5){\n            document.getElementById(this.turn.name).style.backgroundColor = \"aqua\"\n            return true\n        }\n        return false\n    }\n}\n\n\n//# sourceURL=webpack:///./src/game.js?");
